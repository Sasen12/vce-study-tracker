...
CREATE TABLE community_chess_matches (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  week_start DATE NOT NULL,
...
CREATE INDEX community_chess_matches_white_status_idx ON community_chess_matches(white_user_id, status);
CREATE INDEX community_chess_matches_black_status_idx ON community_chess_matches(black_user_id, status);
CREATE INDEX community_chess_matches_week_round_idx ON community_chess_matches(week_start, round);
