...
const sameSubjectName = (left?: string | null, right?: string | null) => {
...
export const repairLearningSignalSubjects = async (userId: string) => {
...
const targetForSignal = (
  signal: StudentMemorySignalDraft,
  eventTarget: ResolvedSubjectMemoryTarget,
