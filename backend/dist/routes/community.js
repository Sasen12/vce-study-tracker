...
communityRouter.post("/subject-rooms/:roomId/chat", asyncHandler(async (req, res) => {
    ...
    if (allowance.remainingMinutes <= 0) {
        throw new HttpError(429, `Study ${CHAT_UNLOCK_STUDY_MINUTES} minutes today to unlock ${CHAT_UNLOCK_MESSAGES} messages. Study ${ROOM_CHAT_UNLOCK_STUDY_MINUTES} for unlimited room chat today.`);
    }
